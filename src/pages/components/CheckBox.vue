<template>
  <PageLayout :header="useRoute().meta.pageTitle">
    ...
    <div class="cursor-pointer pa-10 bg-primary text-white no-text-select d-inline-block mb-20" @click="validateFormGen">
      Validate
    </div>
    <div>
      ...
      <Message name="checkbox@checker" :validateValue="checkBoxValue1 === true || checkBoxValue2 === true ? true : undefined
        " :validate="Yup.boolean().required().nullable()" />
    </div>
    ...
    <div>
      <CheckBox :disabled="disableInput" label="checkbox false" name="checkboxdisabled" :checkboxValue="false" showDetail>
      </CheckBox>
    ...
    <div>
      <CheckBox :readonly="readonly" label="checkbox false" name="checkboxreadonly" :checkboxValue="false" showDetail>
      </CheckBox>
    ...
    <div class="text-h3 mt-20 mb-10 py-5">
      Note: For error habdle use message component
    </div>
