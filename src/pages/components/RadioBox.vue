<template>
    <PageLayout :header="useRoute().meta.pageTitle">
        ...
        <div>
            <RadioBox placeholder="Placeholder" label="Radio false" v-model="radioValue" name="radio" radioValue="xxx"
                showDetail></RadioBox>
            <RadioBox placeholder="Placeholder" label="Radio true" v-model="radioValue" name="radio" radioValue="yyy"
                showDetail></RadioBox>
        ...
        <div class="cursor-pointer pa-10 bg-primary text-white no-text-select d-inline-block mb-20"
            @click="disableInput = !disableInput">Disabled</div>
        <div>
            <RadioBox :disabled="disableInput" placeholder="Placeholder" label="Radio false" name="radiodisabled"
                :radioValue="false" showDetail></RadioBox>
            <input :disabled="disableInput" type="radio" class="site-radio" name="radiodisabled" />
        </div>
        <h4 class="mb-15">Example Of read only</h4>
        <div class="cursor-pointer pa-10 bg-primary text-white no-text-select d-inline-block mb-20"
            @click="readonly = !readonly">Read only</div>
        <div>
            <RadioBox :readonly="readonly" placeholder="Placeholder" label="Radio false" name="radioreadonly"
                :radioValue="false" showDetail></RadioBox>
