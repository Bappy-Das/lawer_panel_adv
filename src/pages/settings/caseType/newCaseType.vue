<template>
    <PageLayout header="" subHeader="New Case Type" width="100%" @setScreenWidth="screenW = $event"
        :padding="screenW < 650 ? '10px 10px 40px 10px' : '25px 25px 50px 25px'">
        <div class="px-5 mb-30">
            <div class="d-flex-center-start">
                <i class="fa-solid fa-plus"></i>
                <h3 class="text ma-3 px-5">Add New Case Type</h3>
            </div>
        </div>
        <hr class="hr-line" />
        <!-- -------------------------------------------------------------------- -->
        <form method="post" @submit="onSubmit" id="delivery-form" enctype="multipart/form-data">
            <div class="input-group-container col-wrap mt-20">
                <div class="input-container col-6 col-12-md">
                    <div class="input-title">Case Type Name<span class="input-title-require">*</span></div>
                    <InputBox type="text" placeholder="Enter Case Type Name" id="case_type_name" name="case_type_name"
